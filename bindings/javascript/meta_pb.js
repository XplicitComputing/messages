...
/**
 * @param {string} value
 * @return {!proto.Messages.Representation} returns this
 */
...
proto.Messages.Representation.prototype.clearDisplacementScaleList = function() {
  return this.setDisplacementScaleList([]);
};
 ...
 * @return {!proto.Messages.Visual} returns this
*/
...
proto.Messages.Visual.prototype.clearIndicesPerElementList = function() {
  return this.setIndicesPerElementList([]);
};
...
proto.Messages.Visual.prototype.clearElementsToIndicesList = function() {
  return this.setElementsToIndicesList([]);
};
...
proto.Messages.Visual.prototype.clearIndicesToElementsList = function() {
  return this.setIndicesToElementsList([]);
};
...
/**
 * @param {number} value
 * @return {!proto.Messages.GraphicsControl} returns this
 */
 ...
 * @return {!proto.Messages.SliceControl} returns this
*/
...
/**
 * @param {?proto.Messages.Visual|undefined} value
 * @return {!proto.Messages.TracersControl} returns this
*/
...
proto.Messages.TracersControl.prototype.clearSpawnRegionList = function() {
  return this.setSpawnRegionList([]);
};
...
proto.Messages.TracersControl.prototype.clearRegenRegionList = function() {
  return this.setRegenRegionList([]);
};
...
proto.Messages.TracersControl.prototype.clearUserDefinedPositionsList = function() {
  return this.setUserDefinedPositionsList([]);
};
...
/**
 * @param {string} value
 * @return {!proto.Messages.Meta} returns this
 */
...
proto.Messages.Meta.prototype.clearModelTransformList = function() {
  return this.setModelTransformList([]);
};
