...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      {
        .name = "representation",
        .dataTypeSpecific.className = GPBStringifySymbol(Representation),
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "visual",
        .dataTypeSpecific.className = GPBStringifySymbol(Visual),
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      {
        .name = "appearance",
        .dataTypeSpecific.className = GPBStringifySymbol(GraphicsControl),
