 ...
 **/
@interface SpatialRoot : GPBRootObject
@end
...
@interface GridControl : GPBMessage
...
@interface MeshControl : GPBMessage
...
@interface TreeControl : GPBMessage
