...
@interface Representation : GPBMessage
...
@interface GraphicsControl : GPBMessage
...
@interface SliceControl : GPBMessage
...
@interface TracersControl : GPBMessage
